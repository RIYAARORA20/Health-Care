...
return (
  <div>
    ...
    <form>
            ...
            <div key={index}>
                <div>
                    <div className="grid grid-cols-2 gap-5">
                        ...
                        value={item.startingDate} className="form_input"
                        ...
                        value={item.endingDate} className="form_input"
                        onChange={e => handleQualificationChange(e,index)}
                        />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        ...
                        value={item.degree} className="form_input"
                        onChange={e => handleQualificationChange(e,index)}
                        />
                        </div>
                        <div>
                        ...
                        value={item.university} className="form_input"
                        onChange={e => handleQualificationChange(e,index)}
                        />
                        </div>
                    </div>
            ...
            <div key={index}>
                <div>
                    <div className="grid grid-cols-2 gap-5">
                        ...
                        onChange={e => handleExperienceChange(e,index)}className="form_input"/>
                        </div>
                    </div>
                ...
                <div>
                    <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                        <div>
                            ...
                            onChange={e=>handleTimeSlotChange(e,index)}className="form_input py-3.5">
                        ...
                        <div>
                            ...
                            onChange={e=>handleTimeSlotChange(e,index)}className="form_input"/>
                        </div>
                        <div>
                        ...
                        <div onChange={e =>deleteTimeSlot(e,index)}className="flex items-center">
      ...
      <div className="mt-7">
          <button type="submit" onClick={updateProfileHandler} className="bg-primaryColor text-white leading-[30px] w-full py-3 px-4 rounded-lg">Update Profile</button>
      </div>
